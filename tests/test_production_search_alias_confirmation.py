...
def test_confirmation_cli_is_blocked_and_creates_no_bundle(tmp_path, capsys):
...
def test_reports_are_complete_deterministic_and_formal_systems_unchanged(tmp_path):
    protected = [
